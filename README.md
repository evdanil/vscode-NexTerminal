...
- **Encrypted backup and share export** — a master-password-protected backup, or a sanitized export to share (credentials stripped, IDs remapped, inventory sources carried as a cache of their synced servers); a hand-written JSON file imports too. → [Encrypted Backup and Share Export](docs/import-export.md#encrypted-backup-and-share-export)
