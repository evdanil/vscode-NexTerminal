export interface SettingMeta {
  ...
  category: "logging" | "ssh" | "securityData" | "tunnels" | "terminal" | "ui" | "sftp" | "serial" | "scripts" | "localServers";
  description?: string;
  badge?: string;
  badgeClass?: string;
...
export const CATEGORY_ORDER = ["logging", "ssh", "securityData", "tunnels", "terminal", "ui", "sftp", "serial", "scripts", "localServers"] as const;
