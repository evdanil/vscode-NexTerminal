...
<body>
  ...
  <script${nonceAttr}>
    ...
    (function() {
       ...
       *
       * REVIEW FINDING (P1) — that deferral only works if something is PENDING
       * by the time submit is dispatched, and a commit does not only happen on
       * blur. The round trip is started from "change" on purpose (deriving a
