...
const unsupportedCommands = [
  ...
  "nexus.macro.newFolder",
  "nexus.macro.moveToFolder",
  "nexus.macro.addToFolder",
  "nexus.macro.renameFolder",
  "nexus.macro.removeFolder",
  "nexus.files.browse",
  "nexus.files.open",
  "nexus.files.upload",
  ...
  "nexus.script.stop",
  "nexus.script.new",
  "nexus.script.newFolder",
  "nexus.script.refresh",
