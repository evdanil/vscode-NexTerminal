...
impl Daemon {
    ...
    fn handle_configure(&mut self, request: &Request) -> Outgoing {
        ...
        match self.apply_configs(&configs) {
            ...
            Err(message) => Outgoing::error(request.id, ErrorCode::InvalidRequest, message),
        }
    }
    ...
    fn handle_start(&mut self, request: &Request) -> Outgoing {
        ...
        match service {
            ...
            unknown => Self::invalid_service(request.id, unknown),
        }
    }
    ...
    fn handle_stop(&mut self, request: &Request) -> Outgoing {
        ...
        match Self::service_id(request) {
            ...
            Ok(unknown) => Self::invalid_service(request.id, unknown),
            Err(response) => response,
        }
    }
    ...
    fn service_id(request: &Request) -> Result<&'static str, Outgoing> {
        ...
        match raw {
            ...
            // by the peer.
            _ => Err(Self::invalid_service(request.id, raw)),
        }
    }
    ...
    fn apply_inline_config(
        ...
        self.store
            ...
            .map_err(|e| Outgoing::error(request.id, ErrorCode::InvalidRequest, e.0))?;
        self.push_config_to_services();
        Ok(())
    }
    ...
    fn invalid_service(id: i64, service: &str) -> Outgoing {
...
mod tests {
    ...
    #[test]
    fn a_bad_configuration_is_refused_with_invalid_request() {
        let mut h = Harness::new();
        let error = h.call(
            "configure",
    ...
    #[test]
    fn a_bad_dhcp_configuration_is_refused_with_invalid_request() {
        let mut h = Harness::new();
        for bad in [
    ...
    #[test]
    fn an_unknown_method_is_refused_with_invalid_request() {
        let mut h = Harness::new();
        assert_eq!(
    ...
    #[test]
    fn a_missing_id_parameter_is_invalid_request_not_a_panic() {
        let mut h = Harness::new();
